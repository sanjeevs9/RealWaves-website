        ...
        <div className="flex items-center justify-between h-[68px]">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            >
              ...
              <div className={`absolute top-full left-0 pt-3 transition-all duration-300 ${
                ...
                <div className="w-56 bg-white rounded-xl shadow-xl ring-1 ring-black/5 py-2 right-0 md:left-0 md:right-auto">
          ...
          <div className="hidden md:flex items-center">
            <a
              ...
              className="group inline-flex items-center gap-2 border border-[#0B2D72] text-[#0B2D72] px-6 py-2.5 rounded-full hover:bg-[#0B2D72] hover:text-white transition-all duration-300 text-xs sm:text-sm font-semibold tracking-wide"
            >
              <span>+91 90099 90000</span>
              <span className="rounded-full p-1 group-hover:bg-white/15 transition-colors">
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 rounded-lg text-charcoal hover:bg-forest/5 transition-colors"
