        ...
        <div className="flex flex-col items-center justify-center bg-[#F9F9F9] py-16 px-4">
            <div className="max-w-4xl w-full bg-white rounded-3xl shadow-lg overflow-hidden">
                ...
                <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-poppins text-[#2476FE] mb-8 text-center">Who we are</h2>
                    <div className="space-y-6 text-gray-700 text-base md:text-lg lg:text-xl leading-relaxed font-roboto">
